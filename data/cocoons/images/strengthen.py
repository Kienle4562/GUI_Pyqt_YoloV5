...
import cv2
import numpy as np
imageDir="P:/Item/Yolov5/yolov5-mask-42-master/data/cocoons/images/train"     #要改变的图片的路径文件夹
saveDir="P:/Item/Yolov5/yolov5-mask-42-master/data/cocoons/images/strengthen"   #要保存的图片的路径文件夹
