...
#         self.left_img.setPixmap(QPixmap("images/UI/yolo.jpg"))
...
#         pushButton_loadpic = QPushButton("上传图片")
#         pushButton_scanpic = QPushButton("开始检测")
#         pushButton_loadpic.clicked.connect(self.upload_img)
#         pushButton_scanpic.clicked.connect(self.detect_img)
#         pushButton_loadpic.setFont(font_main)
#         pushButton_scanpic.setFont(font_main)
#         pushButton_loadpic.setStyleSheet("QPushButton{color:white}"
...
#         pushButton_scanpic.setStyleSheet("QPushButton{color:white}"
#                                      "QPushButton:hover{background-color: rgb(2,110,180);}"
#                                      "QPushButton{background-color:rgb(48,124,208)}"
#                                      "QPushButton{border:2px}"
#                                      "QPushButton{border-radius:5px}"
...
#         img_detection_layout.addWidget(pushButton_loadpic)
#         img_detection_layout.addWidget(pushButton_scanpic)
...
#         self.vid_img = QLabel()
#         self.vid_img.setPixmap(QPixmap("images/UI/yolo.jpg"))
#         vid_title.setAlignment(Qt.AlignCenter)
#         self.vid_img.setAlignment(Qt.AlignCenter)
#         self.pushButton_streaming = QPushButton("摄像头实时监测")
#         self.pushButton_loadmp4 = QPushButton("视频文件检测")
#         self.pushButton_stopscan = QPushButton("停止检测")
#         self.pushButton_streaming.setFont(font_main)
#         self.pushButton_loadmp4.setFont(font_main)
#         self.pushButton_stopscan.setFont(font_main)
#         self.pushButton_streaming.setStyleSheet("QPushButton{color:white}"
#                                                 "QPushButton:hover{background-color: rgb(2,110,180);}"
#                                                 "QPushButton{background-color:rgb(48,124,208)}"
#                                                 "QPushButton{border:2px}"
#                                                 "QPushButton{border-radius:5px}"
#                                                 "QPushButton{padding:5px 5px}"
#                                                 "QPushButton{margin:5px 5px}")
#         self.pushButton_loadmp4.setStyleSheet("QPushButton{color:white}"
#                                              "QPushButton:hover{background-color: rgb(2,110,180);}"
#                                              "QPushButton{background-color:rgb(48,124,208)}"
#                                              "QPushButton{border:2px}"
#                                              "QPushButton{border-radius:5px}"
#                                              "QPushButton{padding:5px 5px}"
#                                              "QPushButton{margin:5px 5px}")
#         self.pushButton_stopscan.setStyleSheet("QPushButton{color:white}"
#                                         "QPushButton:hover{background-color: rgb(2,110,180);}"
#                                         "QPushButton{background-color:rgb(48,124,208)}"
#                                         "QPushButton{border:2px}"
#                                         "QPushButton{border-radius:5px}"
...
#         vid_detection_layout.addWidget(self.pushButton_streaming)
#         vid_detection_layout.addWidget(self.pushButton_loadmp4)
#         vid_detection_layout.addWidget(self.pushButton_stopscan)
...
#                 self.vid_img.setPixmap(QPixmap("test.jpg"))
#
#                 # self.vid_img
#                 # if view_img:
#                 # cv2.imshow(str(p), im0)
